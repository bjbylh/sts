...
exports.model = {
  ...
  mongo: {
      host: '39.98.93.230', // '127.0.0.1','192.168.0.253', '192.168.2.80', '39.98.93.230'
      port: 27017,
      user: '',
      password: '',
      database: 'yyyyy', // 数据库名称
      options: ''
  }
};
...
exports.websocket = {
    ...
    socketio: {
        handle: socketio,
        //allowOrigin: '127.0.0.1:9991',  // 默认所有的域名都允许访问
